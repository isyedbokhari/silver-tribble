...
public class multipleWindowHandles {
    ...
    // getting all the open windows and storing them in a set of strings
        ...
        // storing the set into an iterator so that we can iterate and assign each 
        //window to separate string
    ...
    //verifying if we have switched over, by getting the current title, 
        ...
        List<WebElement> basicControlsList = 
                driver.findElements(By.xpath("//*[@class='basicControls']/div/ul/li"));
