...
public class TestCase12 {
	...
	@Test
	public void clickOnImageAndAddBookToTheBasketThenRemoveItAndPressUpdateBasketButton() throws InterruptedException {
		Driver.getDriver().findElement(By.id("menu-item-40")).click();
		Driver.getDriver().findElement(By.xpath("//*[@class='woocommerce-breadcrumb']//a")).click();
		...
		System.out.println("What's there to update bro!?!?!?");
	}
		Thread.sleep(2000);
	}
}
