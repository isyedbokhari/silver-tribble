...
public class TestCase10 {
	...
	@Test
	public void clickOnImageAndAddBookBasketAndUseCoupon() throws InterruptedException {
		Driver.getDriver().findElement(By.id("menu-item-40")).click();
		Driver.getDriver().findElement(By.xpath("//*[@class='woocommerce-breadcrumb']//a")).click();
		...
		System.out.println("Can't use the coupon 'krishnasakinala' since there's nothing in stock!");
		System.out.println("Can't use the coupon 'krishnasakinala' since first of all there's nothing in stock and secondly the coupon is valid for a purchase of > Rs 450.");
	}
		Thread.sleep(2000);
	}
}
