...
public class TestCase14 {
	...
	@Test
	public void clickOnImageAndAddBookToTheBasketThenProceedToTheCheckoutPageAndCheckTheFinalPrice() throws InterruptedException {
		Driver.getDriver().findElement(By.id("menu-item-40")).click();
		Driver.getDriver().findElement(By.xpath("//*[@class='woocommerce-breadcrumb']//a")).click();
		...
		System.out.println("CATALOG IS FINISHED HENCE NO FURTHER TEST CAN BE PERFORMED ON THIS FUNCTIONALITY!");
	}
		Thread.sleep(2000);
	}
}
